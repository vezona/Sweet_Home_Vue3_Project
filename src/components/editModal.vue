                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" type="text" class="form-control" placeholder="請輸入產品描述" v-model="temp.description">
            </textarea>
                        </div>
                        <div class="form-group">
                            <label for="content">說明內容</label>
                            <textarea id="description" type="text" class="form-control" placeholder="請輸入說明內容" v-model="temp.content">
            </textarea>
                        </div>
                        <div class="form-group">
